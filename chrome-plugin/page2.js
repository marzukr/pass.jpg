...
function hide() {
    var stego = document.getElementById("stego"),
        img = "images/passimage2.jpg",
        cover = document.getElementById("cover"),
        password = "Ww2VW3duGQ=[?PYqH}64E=K3",
        download = document.getElementById("passimage2.jpg");
    if(img && password) {
        console.log("image encoded");
        cover.src = steg.encode(password, img);
